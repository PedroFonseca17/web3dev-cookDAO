...
const App = () => {
  const token = useToken("0x5334c61523d42ef5acAcDDBdEDc266752a166b6C");
  const vote = useVote("0x2eEaCD499B8c715176a6DFA1b7266a635bF7Ab57");
  ...
  const editionDrop = useEditionDrop("0x6aEe0d982e5A1F9B6D301563693bb32B36551E5b");
  ...
  if (!address) {
    return (
      <div className="landing">
        <h1>Bem-vind@s à COOKDAO a DAO dos melhores cozinheiros do mundo</h1>
...
if (hasClaimedNFT) {
  return (
    <div className="member-page">
      ...
      <p>Parabéns por fazer parte desse clube de cozinheiros!</p>
      <div>
          <div>
            <h2>Melhores cozinheiros</h2>
  ...
  return (
    <div className="mint-nft">
      <h1>Cunhe gratuitamente seu NFT de membro da COOKDAO</h1>
      <button
        disabled={isClaiming}
        onClick={mintNft}
      >
